1. ~~Продумать какие компоненты будут~~
2. ~~Продумать функционал компонентов~~
3. Продумать их взамодействие
4. На основе их взаимодействия продумать поток данных между ними
